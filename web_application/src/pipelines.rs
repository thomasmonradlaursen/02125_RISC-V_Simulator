...
pub fn simple_pipeline(hazard: bool, forwarding: bool) -> Vec<f32> {
    ...
    // Immidiate generator
    let imm_gen: Vec<f32> = components::imm_gen(340.0, 150.0, width, height);
    ...
    let wire_ifid_imm: Vec<f32> = components::wire((280.0, 175.0), (340.0, 175.0), width, height);
    ...
    components.push(wire_idex_pc_1);
